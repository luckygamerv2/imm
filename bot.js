...
if (message.content === 'b!invite') {
      message.author.send(' [❖═════ Link ═══════❖]                https://discordapp.com/api/oauth2/authorize?client_id=549167185151524865&permissions=0&scope=bot         luckygamer#0111صنع       	  ').catch(e => console.log(e.stack));
...
client.login('NTQ5Mjk4NzUwMTQxNjI4NDM2.D1R2fw.RUajbkUFMW2gBeMx_lbka6n8hqc');